...
export function MenuInner() {
  ...
  return (
    <>
      ...
      <MenuInnerWithSub title='Crafted' to='/' menuPlacement='bottom-start' menuTrigger='click'>
        {/* PAGES */}
        <MenuInnerWithSub
          title='Pages'
          to='/settings/'
        ...
        <MenuInnerWithSub
          ...
          menuTrigger={`{default:'click', lg: 'hover'}`}
        >
          <MenuItem to='/settings' title={intl.formatMessage({id: 'Overview'})} hasBullet={true} />
          <MenuItem to='/settings' title={intl.formatMessage({id: 'Settings'})} hasBullet={true} />
        </MenuInnerWithSub>
