    ...
    <>
      {location.pathname.includes("/settings") && (
        <div className="d-flex align-items-center gap-2 gap-lg-3">
          <div className="d-flex flex-grow align-items-center w-200px w-sm-300px flex-column mt-3">
            <div className="d-flex flex-grow justify-content-between w-100 mt-auto mb-2">
            ...
            <div
              className="h-8px mx-3 w-100 mb-3 rounded"
