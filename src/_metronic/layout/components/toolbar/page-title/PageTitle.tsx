  ...
  return (
    ...
    >
      ...
      {config.app?.pageTitle?.display && pageTitle && (
        <h1
          className={clsx('page-heading d-flex text-dark fw-bold fs-4', {
      ...
      {pageBreadcrumbs &&
        ...
        config.app?.pageTitle?.breadCrumb && (
          <>
            ...
            <ul className='breadcrumb breadcrumb-separatorless fw-semibold font-size-12 my-2'>
              ...
              {pageDescription !== 'undefined' ? (
                <li className='breadcrumb-item text-muted text-dark'>{pageDescription}</li>
              ) : (
                ''
              )}
            </ul>
