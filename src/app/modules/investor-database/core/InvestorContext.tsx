...
const InvestorContext = createContext<InvestorContextProps>(
  initInvestorContextPropsState
);
...
const InvestorDatabaseProvider: FC<WithChildren> = ({ children }) => {
  ...
  const [sort_by_investorDb, set_sort_by_investorDb] = useState<
    string | undefined
  >(undefined);
  const [sort_order_investorDb, set_sort_order_investorDb] = useState<
    string | undefined
  >(undefined);
  return (
