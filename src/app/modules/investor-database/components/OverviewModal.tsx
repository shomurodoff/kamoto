...
export const OverviewModal = ({
  ...
  useEffect(() => {
    const fetchCountry = async () => {
      ...
      const investorlocationData = investorLocations.map(
        (investorLocation: any) => {
          return {
  ...
  const onSubmit = async (values: any) => {
    if (id) {
      ...
      const payload = {
        ...
        fund_type,
        location,
        investment_count: values.investments,
      };
      ...
      try {
        ...
        if (success) {
          ...
          toast.success(
            formatMessage({ id: "overview Data added successfully" })
          );
                    ...
                    <div className="w-100 row d-md-flex justify-content-between">
                      ...
                      <div className="col-md-6">
                        <TextInput
                          ...
                          toolTipText={formatMessage({
                            id: "GLOBAL.TOOLTIP.HIGHLIGHTS.FUND_SIZE",
                          })}
