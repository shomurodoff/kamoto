        ...
        <ul className="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
          <li className="nav-item font-size-13 font-weight-400">
            <Link
              className={
                ...
                ((location.pathname ===
                  `/investor-database/create-investor/${id}` &&
                  "active") ||
                  (location.pathname === `/investor-database/create-investor` &&
                    "active"))
              }
          ...
          <li className="nav-item font-size-13 font-weight-400">
            <Link
              ...
              to={
                id ? `/investor-database/create-investor/highlights/${id}` : ""
              }
            >
          ...
          <li className="nav-item font-size-13 font-weight-400">
            <Link
              to={
                id ? `/investor-database/create-investor/investments/${id}` : ""
              }
              className={
                `nav-link text-active-primary me-6 ` +
