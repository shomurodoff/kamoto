...
const InvestorCard = ({
  ...
  useEffect(() => {
    const isPresent = investor.columns?.find(
    ...
    <>
      ...
      >
        <div>
          <div className="d-lg-flex justify-content-lg-between d-xl-flex justify-content-xl-between d-md-block d-block">
            <div className="d-flex gap-5">
              ...
              <div>
                ...
                <button className="font-size-12 p-2 button-radius">
                  Secondary
                </button>
                <div className="d-flex gap-2 justify-content-start my-3">
                  ...
                  {investor.linkedin_url && (
                    ...
                    >
                      <img
                        src={toAbsoluteUrl(
                          "/media/icons/investor/LinkedIn.svg"
                        )}
                        height={20}
                        alt="linkedIn"
                      />
                  ...
                  {investor.facebook_url && (
                    <a
                      target="_blank"
                      href={investor.facebook_url}
                      rel="noreferrer"
                    >
                      {" "}
                      <img
                        src={toAbsoluteUrl(
                          "/media/icons/investor/Facebook.svg"
                        )}
                        height={20}
                        alt="facebook"
                      />
                  ...
                  {investor.insta_url && (
                    <a
                      target="_blank"
                      href={investor.insta_url}
                      rel="noreferrer"
                    >
                      <img
                        src={toAbsoluteUrl(
                          "/media/icons/investor/Instagram.svg"
                        )}
                        height={20}
                        alt="instagram"
                      />
          ...
          <div>
            <p className="people-connected">
              {formatMessage({ id: "People Connected" })}
            </p>
                ...
                <div className="mb-2">
                  {peopleData.slice(0, 5).map((item) => (
                    <img
                      ...
                      onClick={() =>
                        navigate(
                          `/investor-database/profile/${item?.investorUserId}`
                        )
                      }
                    />
                  ))}
          ...
          <div className="d-flex gap-4 mt-3 col-12 justify-content-between">
            <div>
              ...
              <p className="font-size-13">
                {investor?.fund_type
                  ? JSON.parse(investor?.fund_type).join(", ")
                  : "-"}
              </p>
            </div>
            <div>
