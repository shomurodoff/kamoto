...
import {getFocusArea, getInvestorGeography, getStageFocus, updateInvestor} from '../core/_requests'
...
const InvestmentThesisModal = ({
  ...
  const [initialInvestorGeography, setInitialInvestorGeography] = useState<any>()
    ...
    if (id) {
      try {
        ...
        if (success) {
          ...
          toast.success(formatMessage({id: 'Investments updated successfully'}))
        ...
        <Formik initialValues={initialValues} validationSchema={userSchema} onSubmit={onSubmit}>
          {(formik: any) => {
            ...
            individualInvestor?.funding_requirement &&
              (formik.initialValues.fundingRequirement = individualInvestor?.funding_requirement)
            return (
              <Form>
                <Modal.Body>
                      ...
                      <div className='col-md-6 multi-select w-100 investor_type'>
                        ...
                        <div className='highlight-multi-select font-size-12 text-bold mobile-investorType'>
                          <Select
                            ...
                            placeholder={formatMessage({id: 'Choose Stage Focus'})}
                      ...
                      <div className='col-md-6 d-flex align-items-center justify-content-center tablet-investment'>
                        <div className='col-5'>
                          <TextInput
                            ...
                            formik={formik}
                            placeholder={formatMessage({id: 'Enter min range'})}
                            toolTipText={formatMessage({
                        ...
                        <div className='col-5 mt-7 mt-md-0'>
                          <TextInput
                            ...
                            formik={formik}
                            placeholder={formatMessage({id: 'Enter max range'})}
                            margin={'me-md-0 mt-6'}
                      ...
                      <div className='col-md-6 multi-select w-100 investor_type target-sector'>
                        ...
                        <div className=' highlight-multi-select font-size-12 text-bold mobile-investorType'>
                          <Select
                            ...
                            placeholder={formatMessage({id: 'Choose Target Sector'})}
                            classNamePrefix='react-select'
                      ...
                      <div className='col-md-6 multi-select w-100 investor_type target-geography'>
                        ...
                        <div className=' highlight-multi-select font-size-12 text-bold mobile-investorType'>
                          <Select
                            ...
                            placeholder={formatMessage({id: 'Choose Target Geography'})}
                            classNamePrefix='react-select'
