...
const TwitterHandleModal = ({
  setTwitterHandleModalShow,
  twitterHandleModalShow,
  singleInvestor,
  individualInvestor,
}: any) => {
    ...
    if (id) {
      try {
        ...
        if (success) {
          ...
          toast.success(
            formatMessage({ id: "Twitter URL updated successfully" })
          );
          setLoading(false);
                ...
                <Modal.Body>
                  ...
                  <div className="d-flex align-items-center">
                    <div className="mt-0 pt-0 m-8 d-flex gap-3 ms-0">
                      <img
                        src={toAbsoluteUrl(
                          `/media/icons/duotune/social/twitter.svg`
                        )}
                        width="20px"
                        height="20px"
                        alt="twitter"
