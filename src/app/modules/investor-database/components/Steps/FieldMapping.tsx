            ...
            <Form>
              <div>
                <div className="d-flex flex-md-row flex-column gap-0 align-items-center">
                  <p className="col-md-2 col-12 mb-md-0 mb-2 font-weight-500 font-size-13">
                    {formatMessage({ id: "Use saved maps" })}
                  </p>
                  <Field
                    as="select"
                    // name={fieldName}
                    ...
                    <tbody>
                      {importInvestorTable.map((e) => (
                        <tr>
                          ...
                          <td className="min-w-200px">
                            <p className="text-hover-primary font-weight-400 font-size-13 text-clr38 border h-40px mb-0 rounded-1"></p>
                          </td>
                        </tr>
                      ))}
                    </tbody>
                ...
                <div className="d-flex flex-md-row flex-column align-items-center gap-4 mt-10">
                  <div className="d-flex align-items-center gap-3 text-left col-md-2 col-12">
                    <input
                      type="checkbox"
                      className="h-20px w-20px bg-clrDB rounded-1"
                    />
                    <div className="font-weight-400 font-size-12 text-clr58">
                      {formatMessage({ id: "Save as Custom mapping" })}
                    </div>
                  </div>
