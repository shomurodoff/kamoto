          ...
          return (
            <Form>
              <div className="font-size-12">
                <SelectInput
                  label={formatMessage({
                    id: "Select how duplicate records should be handle",
                  })}
                  fieldName={"records"}
              ...
              <div>
                <p className="font-weight-500 font-size-13">
                  {formatMessage({
                    id: "Select the matching fields to find duplicate records",
                  })}
                </p>
                <div className="d-flex flex-md-row flex-column justify-content-between mt-8">
                  ...
                  <div className="d-flex flex-column align-items-center gap-5 justify-content-center">
                    <img
                      src={toAbsoluteUrl(
                        "/media/icons/investor/right-thin-arrow.svg"
                      )}
                      alt="right arrow"
                    ...
                    <img
                      src={toAbsoluteUrl(
                        "/media/icons/investor/left-thin-arrow.svg"
                      )}
                      alt="left arrow"
                      className="d-flex d-md-block d-none"
                    />
                  ...
                  <div className="d-flex justify-content-center d-md-none d-block my-5 gap-5">
                    <img
                      src={toAbsoluteUrl(
                        "/media/icons/investor/up-thin-arrow.svg"
                      )}
                      alt="up arrow"
                    ...
                    <img
                      src={toAbsoluteUrl(
                        "/media/icons/investor/down-thin-arrow.svg"
                      )}
                      alt="down arrow"
                      className="d-flex d-md-none d-block"
                    />
                  ...
                  <div>
                    ...
                    <div className="import-field-csv border overflow-auto p-8">
                      {leftDummyData.map((e) => {
                        return (
                          <p className="font-size-12 text-clr88 cursor-pointer p-2">
                            {e}
                          </p>
                        );
                      })}
