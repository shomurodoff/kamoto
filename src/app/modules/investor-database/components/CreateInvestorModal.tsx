...
import {createInvestor, getActiveRound, getAddToCRMData} from '../core/_requests'
    ...
    try {
      ...
      if (fund_type.length > 0) {
        ...
        if (success) {
          ...
          navigate(`/investor-database/individual-investor/${data?.investorId}`)
          if (addCRMToggle) {
            try {
              const {
                data: {success, errors},
                ...
                <Modal.Body>
                  <div className='d-md-flex col-md-12 flex-wrap w-100 m-auto justify-content-center'>
                    ...
                    <TextInput
                      ...
                      toolTipText={formatMessage({id: 'GLOBAL.TOOLTIP.GENERAL.CONTACT_NAME'})}
                      margin='me-6'
                      width={5}
                      isStarRequired={true}
                    />
                    ...
                    <div className='form-check form-switch form-switch-md form-check-custom form-check-solid toggle-width'>
                      ...
                      <label className='form-check-label font-size-13'>
                        {formatMessage({id: 'Also, add this investor to CRM'})}
                      </label>
                    </div>
                  </div>
                </Modal.Body>
