...
export function General() {
  ...
  const userSchema = Yup.object().shape({
    ...
    website: Yup.string()
      .url(
        formatMessage({
          id: formatMessage({ id: "Please Enter the valid URL" }),
        })
      )
  ...
  const onSubmit = async (values: any) => {
    ...
    try {
      ...
      if (success) {
        ...
        setLoading(false);
        navigate(
          `/investor-database/create-investor/highlights/${investor.investorId}`
        );
      } else {
        setLoading(false);
                  ...
                  <Form>
                    <div className="d-md-flex col-md-12 flex-wrap">
                      ...
                      <TextInput
                        ...
                        toolTipText={formatMessage({
                          id: "GLOBAL.TOOLTIP.GENERAL.COMPANY",
                        })}
                        margin="me-4"
                        width={5}
                        isStarRequired={true}
                      ...
                      <TextInput
                        ...
                        toolTipText={formatMessage({
                          id: "GLOBAL.TOOLTIP.GENERAL.WEBSITE",
                        })}
                        width={5}
                        margin="me-6"
                        isStarRequired={true}
                      ...
                      <Country
                        ...
                        tooltipText={formatMessage({
                          id: "GLOBAL.TOOLTIP.GENERAL.COUNTRY",
                        })}
                        width={5}
                      />
                      <TextInput
                        ...
                        toolTipText={formatMessage({
                          id: "GLOBAL.TOOLTIP.GENERAL.EXITS",
                        })}
                        margin="me-4"
                        width={5}
                        isStarRequired={true}
                      ...
                      <div className="highlight-multi-select font-size-12 text-bold  ms-2 mt-0">
                        <div className="d-flex">
                          ...
                          <ToolTipUI
                            tooltipText={formatMessage({
                              id: "GLOBAL.TOOLTIP.GENERAL.INDUSTRY",
                            })}
                          />
                        </div>
                        <Select
                      ...
                      <div className="mt-md-3 mt-5 w-100">
                        ...
                        {investorsocialMediaData.map(
                          ({
                            ...
                            <div
                              className="d-flex flex-md-row  mb-md-4 social-media"
                              key={id}
                            >
