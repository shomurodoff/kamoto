...
export const IndividualInvestorDetails = () => {
  ...
  const [generalDetailsModalShow, setGeneralDetailsModalShow] = React.useState(false)

  const [showInvestorKebabMenu, setShowInvestorKebabMenu] = useState(false)
  const [showInvestorUserKebabMenu, setShowInvestorUserKebabMenu] = useState(false)
  ...
  const [investmentThesisModalShow, setInvestmentThesisModalShow] = useState(false)
  ...
  const getAllInvestorUser = async () => {
    try {
      ...
      } = await AllInvestorUser(Number(id), searchInvestorUser, sortOrderUser, sortByUser)
      if (success) {
  ...
  const addToFavorite_InvestorUser = async (investorUserId: number, isFavourite: boolean) => {
    try {
      const {
        data: {success, errors},
      } = await AddToFavorite({
      ...
      <div className='profile-container py-5 px-5 w-100'>
        <div className='card w-100 p-5 p-md-7 d-flex flex-md-row flex-column justify-content-between'>
          <div className='col-md-8 col-12 '>
            <div className='d-flex gap-4'>
              ...
              <div className='w-100'>
                <div className='d-flex gap-3'>
                  <h2>{individualInvestor?.name ? individualInvestor?.name : 'NA'}</h2>
                  <span className='badge badge-light-primary button-radius'>Popular</span>
                </div>
                <div className='pe-4 pt-2'>
                  <p>{individualInvestor?.description ? individualInvestor?.description : 'NA'}</p>
                </div>
              </div>
            </div>
            <div className='d-flex flex-md-row flex-column'>
              ...
              >
                {individualInvestor?.linkedin_url && (
                  <a href={individualInvestor.linkedin_url} target='_blank' rel='noreferrer'>
                    <img
                ...
                {individualInvestor?.twitter_url && (
                  <a href={individualInvestor.twitter_url} target='_blank' rel='noreferrer'>
                    <img
                ...
                {individualInvestor?.facebook_url && (
                  <a href={individualInvestor.facebook_url} target='_blank' rel='noreferrer'>
                    <img
                ...
                {individualInvestor?.insta_url && (
                  <a href={individualInvestor.insta_url} target='_blank' rel='noreferrer'>
                    <img
              ...
              <div className='d-flex gap-md-15 gap-5 mt-md-0 mt-5'>
                <div className='d-flex align-items-center gap-3'>
                  <img src={toAbsoluteUrl('/media/icons/investor/websiteLogo.svg')} alt='' />
                  <div>{individualInvestor?.website ? individualInvestor?.website : 'NA'}</div>
                </div>
                <div className='d-flex align-items-center gap-3'>
                  <img src={toAbsoluteUrl('/media/icons/investor/Location.svg')} alt='location' />
                  <div>
                ...
                <div className='d-flex align-items-center gap-3'>
                  <img src={toAbsoluteUrl('/media/icons/investor/people.svg')} alt='' />
            ...
            >
              ...
              {showInvestorKebabMenu && (
                ...
                >
                  ...
                  >
                    <button type='button' className='m-0 border-0 bg-transparent text-dark'>
        ...
        <div className='card w-100 p-5 p-md-7 mt-6'>
          <div className='d-flex justify-content-between'>
            <div className='w-100 d-flex justify-content-between align-items-center align-self-center'>
              ...
              <button className='btn btn-light py-2' onClick={() => setOverviewModalShow(true)}>
                {formatMessage({id: 'Edit'})}
              </button>
            </div>
          </div>
          ...
          <div className='d-flex col-md-12 col-12 w-md-85 w-100 flex-wrap'>
            ...
            <div className='col-md-3 col-6 d-flex flex-column align-items-md-center align-items-start mb-7'>
              <div className='col-md-8'>
                ...
                <div className='font-size-13'>
                  {individualInvestor.investment_count ? individualInvestor.investment_count : '-'}
                </div>
              </div>
            </div>
          </div>
        ...
        <div className='card p-7 mt-6'>
          <div className='d-flex justify-content-between'>
            ...
            <div className='d-flex gap-3'>
              <button className='btn btn-light py-3' onClick={() => setUserModalShow(true)}>
                        ...
                        <div className='text-dark  font-size-13 w-100px w-md-50'>
                          ...
                          {isAdded ? (
                            user?.rounds.length > 0 ? (
                              <img
                                src={toAbsoluteUrl('/media/icons/investor/isFavourite.svg')}
                                width='16px'
                                height='16px'
                                alt='favourite icon'
                                className='ms-2 cursor-pointer'
                                onClick={() => {
                                  addToFavorite_InvestorUser(user?.investorUserId, false)
                                }}
                              />
                            ) : (
                              <img
                                src={toAbsoluteUrl('/media/icons/investor/notIsFavourite.svg')}
                                width='16px'
                                height='16px'
                                alt='favourite icon'
                                className='ms-2 cursor-pointer'
                                onClick={() => {
                                  addToFavorite_InvestorUser(user?.investorUserId, true)
                                }}
                              />
                            )
                          ) : (
                      ...
                      <td className='text-left text-end position-relative '>
                        <button
                          ...
                          onClick={() => {
                            ...
                            setShowInvestorUserKebabMenu(!showInvestorUserKebabMenu)
                          }}
                        >
                          <img src={toAbsoluteUrl('/media/icons/investor/threeDots.svg')} alt='' />
                        </button>
                        {showInvestorUserKebabMenu && investorUserId === user.investorUserId && (
                          <div
                            className='card w-150px shadow-sm rounded kebab-menu-dropdown-container cursor-pointer text-center'
                            onMouseLeave={() => setShowInvestorUserKebabMenu(false)}
                          >
                            <div
        ...
        <div className='card p-7 mt-6'>
          <div className='d-flex flex-md-row flex-column justify-content-between'>
            <div className='d-flex align-self-md-center mb-md-0 mb-2'>
              <p className='fs-4 fw-bold m-0'>{formatMessage({id: 'Investments/Portfolio'})}</p>
            </div>
            <div className='d-flex gap-3'>
              <button className='btn btn-light py-3' onClick={() => setModalShow(true)}>
                      ...
                      <td className='ps-8'>
                        <div className='table-body font-size-12 form-label'>
                          {investment?.announced_date
                            ? getDateValue(
                                new Date(investment?.announced_date).toISOString()?.toString()
                              )
                              ? getDateValue(
                                  new Date(investment?.announced_date).toISOString()?.toString()
                                )
