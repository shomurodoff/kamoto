              ...
              <tbody>
                {!!investorPeople?.length &&
                  investorPeople.map((user: any) => (
                    <tr
                      className="border-top font-size-12 aaa"
                      key={user.investorUserId}
                    >
                      ...
                      <td className="text-center min-w-md-100px min-w-200px">
                        <a
                          ...
                          className="font-weight-500 text-dark fw-bold text-hover-primary mb-1  table-email dark_text_color"
                        >
