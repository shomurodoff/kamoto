                  ...
                  <Form>
                    <div className="d-md-flex col-md-12 flex-wrap">
                      ...
                      <TextInput
                        ...
                        formik={formik}
                        placeholder={formatMessage({
                          id: "Enter Investor stage focus",
                        })}
                        toolTipText={formatMessage({
                          id: "GLOBAL.TOOLTIP.HIGHLIGHTS.STAGE_FOCUS",
                        })}
                        margin="me-4"
                        width={5}
                        isStarRequired={true}
                      ...
                      <div className="me-6 multi-select mb-9">
                        ...
                        <ToolTipUI
                          tooltipText={formatMessage({
                            id: "GLOBAL.TOOLTIP.HIGHLIGHTS.FOCUS_AREA",
                          })}
                        />
