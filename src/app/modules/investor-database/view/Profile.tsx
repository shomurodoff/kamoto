      ...
      <div className='d-flex flex-column gap-5'>
            ...
            <div className='d-flex flex-column gap-5'>
              <div className='d-flex gap-5'>
                <div>
                  <div
                    ...
                    onClick={handleOpen}
                  >
                    <DisplayImage imgName={imgName} height='100px' width='100px' alt='profile' />
                  </div>
                </div>
                <div>
              ...
              <div className='d-flex gap-2  pt-2 col-3'>
                {investorUser?.investor.linkedin_url && (
                  <a href={investorUser?.investor.linkedin_url} target='_blank' rel='noreferrer'>
                    <img
                ...
                {investorUser?.investor.twitter_url && (
                  <a href={investorUser?.investor.twitter_url} target='_blank' rel='noreferrer'>
                    <img
                ...
                {investorUser?.investor.facebook_url && (
                  <a href={investorUser?.investor.facebook_url} target='_blank' rel='noreferrer'>
                    <img
                ...
                {investorUser?.investor.insta_url && (
                  <a href={investorUser?.investor.insta_url} target='_blank' rel='noreferrer'>
                    <img
        ...
        <div className='card p-9'>
          ...
          <div className='highlights mt-4'>
            <div>
              <p className='font-size-12'>{formatMessage({id: 'Investor Type'})}</p>
              <p>
            ...
            <div>
              <p className='font-size-12'>{formatMessage({id: 'Fund Size/AUM'})}</p>
              <p>{investorUser?.investor?.fund_size ? investorUser?.investor?.fund_size : '-'}</p>
            </div>
            <div>
              <p className='font-size-12'>{formatMessage({id: 'Sweet Spot'})}</p>
              <p>{investorUser?.investor?.sweet_spot ? investorUser?.investor?.sweet_spot : '-'}</p>
            </div>
            <div>
              <p className='font-size-12'>{formatMessage({id: 'Investments'})}</p>
              <p>
                {' '}
            ...
            <div>
              <p className='font-size-12'>{formatMessage({id: 'Stage Focus'})}</p>
              <p>
                {investorUser?.investor?.stage_focus ? investorUser?.investor?.stage_focus : '-'}
              </p>
            </div>
            <div>
              <p className='font-size-12'>{formatMessage({id: 'Investment Range'})}</p>
              <p>
            ...
            <div>
              ...
              <p> {investorUser?.investor?.exits ? investorUser.investor.exits : '-'}</p>
            </div>
          </div>
        </div>
