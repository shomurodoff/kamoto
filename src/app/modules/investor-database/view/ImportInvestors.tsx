...
const ImportInvestors = () => {
  ...
  const submitStep = (values: ICreateAccount, actions: FormikValues) => {
    ...
    setCurrentSchema(
      createAccountSchemas[stepper.current.currentStepIndex + 2]
    );
          ...
          <div className="stepper-item current" data-kt-stepper-element="nav">
            <div className="stepper-wrapper d-flex flex-md-row flex-column">
              ...
              <div className="stepper-label mt-md-0 mt-2 ms-md-0 ms-2 text-align-start">
                <h3 className="stepper-title font-size-13">
              ...
              >
                ...
                <div className="d-flex flex-stack pt-10">
                  ...
                  <div className="d-flex gap-6 justify-content-end w-100">
                    ...
                    <button
                      type="submit"
                      className="btn btn-lg btn-primary me-3 w-md-auto w-50 border font-size-13"
                    >
                      <span className="indicator-label">
                        {stepper.current?.currentStepIndex !==
                          stepper.current?.totatStepsNumber! && "Next"}
                        {stepper.current?.currentStepIndex ===
                          stepper.current?.totatStepsNumber! && "Import"}
                      </span>
                    </button>
                  </div>
                </div>
