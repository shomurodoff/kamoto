...
export const EmailIntegration = ({
  ...
  const [sendGridTestEmailLoading, setSendGridTestEmailLoading] = useState(false)
  const [sendPostMarkTestEmailLoading, setSendPostMarkTestEmailLoading] = useState(false)
  ...
  const onSubmitPostmark = async (values: any) => {
    try {
      ...
      if (success) {
        ...
        toast.success(formatMessage({id: 'Postmark config saved successfully'}))
      } else {
        setPostmarkLoading(false)
  ...
  const onSubmitSendgrid = async (values: any) => {
    try {
      ...
      if (success) {
        ...
        toast.success(formatMessage({id: 'Sendgrid config saved successfully'}))
      } else {
        setSendGridLoading(false)
        errors.forEach((error: string) => {
          toast.error(formatMessage({id: error}))
        ...
        <div className='card-body'>
          <div>
            <div>
              <h4 className='card-label'>
                ...
                <ToolTipUI tooltipText={'GLOBAL.TOOLTIP.EMAILINTEGRATION.SENDER_PROFILE'} />
              </h4>
            </div>
                    ...
                    return (
                      <Form>
                        <TextInput
                          ...
                          fieldName={'fromName'}
                          formik={formik}
                          placeholder={formatMessage({id: 'eg. Investor Relation'})}
                        ...
                        <TextInput
                          ...
                          fieldName={'fromEmail'}
                          formik={formik}
                          placeholder={formatMessage({id: 'eg. invest@yourcompany.com'})}
                          toolTipText={formatMessage({
          ...
          <div className=''>
            <h4 className='card-label'>
              ...
              <ToolTipUI tooltipText={'GLOBAL.TOOLTIP.EMAILINTEGRATION.EMAIL'} />
            </h4>
          </div>
                          ...
                          <div className='accordion-item mailer-radio'>
                            ...
                            >
                              <button
                                ...
                                onClick={() => {
                                  setCollapseFoundercrate(!collapseFoundercrate)
                      ...
                      return (
                        <Form>
                          <div className='accordion-item mailer-radio'>
                            ...
                            >
                              <button
                                className={`accordion-button ${collapsePostmark ? 'hideIt' : ''}`}
                                type='button'
                                data-bs-toggle='collapse'
                              ...
                              >
                                ...
                                />
                                <img
                                  src={toAbsoluteUrl('/media/icons/setting/postmark.png')}
                                  alt=''
                                  className='button-icon mt-4 ms-6'
                                />
                                <h6 className=' font-weight-500 font-size-14 text-dark'>
                                ...
                                <div className='d-flex justify-content-end'>
                                  <div>
                                    {sendPostMarkTestEmailLoading ? (
                                      ...
                                      >
                                        {formatMessage({id: 'Send Test Email'})}
                                      </button>
                                    )}
                                  </div>
                                  <div>
                      ...
                      return (
                        <Form>
                          <div className='accordion-item mailer-radio'>
                            ...
                            >
                              <button
                                className={`accordion-button ${collapseSendGrid ? 'hideIt' : ''}`}
                                type='button'
                                data-bs-toggle='collapse'
                              ...
                              >
                                ...
                                />
                                <img
                                  src={toAbsoluteUrl('/media/icons/setting/send_grid.svg')}
                                  alt=''
                                  className='button-icon mt-4 ms-6'
                                />
                                <h6 className='font-weight-500 font-size-14 text-dark'>
                            ...
                            >
                              <div className='accordion-body'>
                                <TextInput
                                  ...
                                  fieldName={'apiKey'}
                                  formik={formik}
                                  placeholder={formatMessage({id: 'Enter API key of sendgrid'})}
                                  toolTipText={formatMessage({
                      ...
                      return (
                        <Form>
                          <div className='accordion-item mailer-radio'>
                            ...
                            >
                              <button
                                className={`accordion-button ${collapseSmtp ? 'hideIt' : ''}`}
                                type='button'
                                data-bs-toggle='collapse'
                              ...
                              >
                                ...
                                />
                                <img
                                  src={toAbsoluteUrl('/media/icons/setting/custom_smts.svg')}
                                  alt=''
                                  className='button-icon mt-4 ms-6'
                                />
                                <h6 className='font-weight-500 font-size-14 text-dark'>
                            ...
                            >
                              <div className='accordion-body'>
                                <TextInput
                                  fieldType={'text'}
                                  label={formatMessage({id: 'SMTP Server Address'})}
                                  fieldName={'server'}
                                  formik={formik}
                                  placeholder={formatMessage({id: 'e.g smtp.gmail.com'})}
                                  toolTipText={formatMessage({
                                ...
                                <TextInput
                                  ...
                                  fieldName={'username'}
                                  formik={formik}
                                  placeholder={formatMessage({id: 'Enter User name'})}
                                  toolTipText={formatMessage({
                                ...
                                <TextInput
                                  ...
                                  fieldName={'password'}
                                  formik={formik}
                                  placeholder={formatMessage({id: 'Enter your password here'})}
                                  toolTipText={formatMessage({
                                ...
                                <div>
                                  <div className='col-md-12'>
                                    <label className='form-label font-size-13 text-dark'>
                                      {formatMessage({id: 'Encrypt type and port number*'})}
                                    </label>
                                    <ToolTipUI
                                      tooltipText={'GLOBAL.TOOLTIP.REFFERAL.ENCRYPTTYPE_PORTNUMBER'}
                                    />
                                  </div>
                                  ...
                                  <div className='row'>
                                    <div className='col-md-2 mt-2 p-0'>
                                      <SelectInput
                                        ...
                                        placeholder={formatMessage({id: 'SSL'})}
                                        formik={formik}
                                    ...
                                    <div className='col-md-10 p-0 pe-2'>
                                      <TextInput
                                        ...
                                        fieldName={'port'}
                                        formik={formik}
                                        placeholder={formatMessage({id: 'e.g 465,587'})}
                                        width={14}
                                        isTooltipNotRequired={true}
