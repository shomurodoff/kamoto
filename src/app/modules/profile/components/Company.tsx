...
import {companyInitialValues, operatingStatusOptions, teamSizeOptions} from '../core/_constants'
        ...
        <div className='col-xl-12 d-md-flex mt-0'>
          <div>
            <div
              ...
              onClick={handleOpen}
            >
              <DisplayImage imgName={companyImgName} width='100%' alt='profile' fit='contain' />
          ...
          <div className='mt-md-8 ms-md-16 w-100 p-5'>
            <div className='fs-6 fw-bold mb-1'>{formatMessage({id: 'General'})}</div>
            <Formik
                  ...
                  <Form>
                    <div className='d-md-flex col-md-12 flex-wrap'>
                      ...
                      <TextInput
                        ...
                        formik={formik}
                        placeholder={formatMessage({id: 'Enter the Company Name'})}
                        margin='me-6'
                        toolTipText={formatMessage({id: 'GLOBAL.TOOLTIP.COMPANY.COMPANY_NAME'})}
                        width={5}
                        isStarRequired={true}
                      />
                      <TextInput
                        ...
                        toolTipText={formatMessage({id: 'GLOBAL.TOOLTIP.COMPANY.TAGLINE'})}
                        width={5}
                        isStarRequired={true}
                      />
                      <SelectInput
                        ...
                        fieldName={'teamSize'}
                        formik={formik}
                        placeholder={formatMessage({id: 'Select the Team Size'})}
                        margin={'me-6'}
                        toolTipText={formatMessage({id: 'GLOBAL.TOOLTIP.COMPANY.TEAM_SIZE'})}
                        width={5}
                      ...
                      <TextInput
                        ...
                        fieldName={'legalName'}
                        formik={formik}
                        placeholder={formatMessage({id: 'Enter the Legal Name'})}
                        toolTipText={formatMessage({id: 'GLOBAL.TOOLTIP.COMPANY.LEGAL_NAME'})}
                        width={5}
                        isStarRequired={true}
                      />
                      <SelectInput
                      ...
                      <TextArea
                        ...
                        toolTipText={formatMessage({id: 'GLOBAL.TOOLTIP.COMPANY.DESCRIPTION'})}
                        width={5}
                        isStarRequired={true}
                      />
                      <TextInput
                        ...
                        toolTipText={formatMessage({id: 'GLOBAL.TOOLTIP.COMPANY.FOUNDING_DATE'})}
                        width={5}
                      ...
                      <SelectInput
                        ...
                        formik={formik}
                        toolTipText={formatMessage({id: 'GLOBAL.TOOLTIP.COMPANY.INDUSTRY'})}
                      ...
                      <SelectInput
                        ...
                        formik={formik}
                        toolTipText={formatMessage({id: 'GLOBAL.TOOLTIP.COMPANY.COUNTRY'})}
                      ...
                      <SelectInput
                        ...
                        formik={formik}
                        toolTipText={formatMessage({id: 'GLOBAL.TOOLTIP.COMPANY.STATE'})}
                      ...
                      <div className='d-md-flex flex-md-column col-md-12'>
                        <TextInput
                          ...
                          fieldName={'founders'}
                          formik={formik}
                          placeholder={formatMessage({id: 'Enter the Founders'})}
                          label={formatMessage({id: 'Founders'})}
                          toolTipText={formatMessage({id: 'GLOBAL.TOOLTIP.COMPANY.FOUNDERS'})}
                          width={5}
