            ...
            return (
              <Form className={'w-full'}>
                <div className={'grid grid-cols-12 md:gap-x-[24px]'}>
                  ...
                  <div
                    className={
                      'col-span-12 bg-[#2E2F45] p-[8px] shadow-[0px_2px_4px_0px_#0000001A] rounded relative mb-[18px]'
                    }
                  >
                    <div
                      className='rounded-full  bg-[#21233A] absolute -top-2 -right-3 p-2 shadow-[0px_2px_4px_0px_#0000001A]'
                  ...
                  <div className={'col-span-12 md:col-span-8'}>
                    <div className={'grid grid-cols-12 flex items-center'}>
                      <div className={'col-span-12 md:col-span-4 lg:col-span-3 flex items-start'}>
                        <label className={'flex items-center gap-[10px] mb-[8px] md:mb-[14px]'}>
                          <svg
                            width='24'
                            height='24'
                            viewBox='0 0 24 24'
