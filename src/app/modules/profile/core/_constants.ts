...
export const EmailPreferencesInput = [
  {
    ...
    subtitle: 'Receive a notification every time the details of your AI personality is edited.',
  ...
  },
  {
    ...
    subtitle: 'Receive a notification for every submission on Train by Private Data',
    toggleLabel: 'trainingPrivate',
  },
  {
    id: 5,
    title: 'Monetization Details updated',
    subtitle: 'Receive a notification when your AI Personality’s monetization details are updated.',
    toggleLabel: 'monetizationDetailsUpdated',
  },
  {
    id: 6,
    title: 'Listing Status Changed',
    subtitle: 'Receive a notification when anyone follows this AI Personality on AI Marketplace',
  ...
  },
  {
    ...
    subtitle: 'Receive a notification when KamotoAI settle the money in your account.',
