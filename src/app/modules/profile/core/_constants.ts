...
export const EmailPreferencesInput = [
  {
    ...
    toggleLabel: 'successfulPayments',
  },
  {
    id: 2,
    title: 'New Investor update',
    subtitle: 'Receive a notification for every initiated payout.',
    toggleLabel: 'newInvestorUpdate',
  },
  {
    id: 3,
    title: 'Fee collection',
    subtitle: 'Receive a notification each time you collect a fee from sales',
    toggleLabel: 'feeCollection',
  },
  {
    id: 4,
    ...
    toggleLabel: 'customerPaymentDispute',
  },
  {
    id: 5,
    title: 'Refund alerts',
    subtitle: 'Receive a notification if a payment is stated as risk by the finance department.',
    toggleLabel: 'refundAlerts',
  },
  {
    id: 6,
    ...
    toggleLabel: 'invoicePayment',
  },
  {
    id: 7,
    title: 'Billing Updates',
    subtitle: 'Receive a notification for consistently failing webhook API endpoints.',
    toggleLabel: 'billingUpdates',
  },
  {
    id: 8,
    title: 'New team members',
    subtitle: 'Receive a notification for consistently failing webhook API endpoints.',
    toggleLabel: 'newTeamMembers',
  },
  {
    id: 9,
    title: 'Completed Investments',
    subtitle: 'Receive a notification for consistently failing webhook API endpoints.',
    toggleLabel: 'completedInvestments',
  },
  {
    id: 10,
    title: 'Newsletters',
    subtitle: 'Receive a notification for consistently failing webhook API endpoints.',
    toggleLabel: 'newsLetters',
  },
]
