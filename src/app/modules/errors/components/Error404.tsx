...
const Error404: FC = () => {
  ...
  return (
    <div className={'flex flex-col items-center text-center'}>
      ...
      <div
        className={`my-5 text-[#FFFFFFA6]  ${
          mode === 'dark' ? 'errorDetailsDark' : 'errorDetails'
        }`}
      >
        The page you are looking for could not be found. Please check the URL or try searching for
        the page using the search bar. We apologize for any inconvenience this may have caused.
      </div>
