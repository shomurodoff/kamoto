      ...
      <div className={'grid grid-cols-12 gap-4 mb-6'}>
        ...
        >
          <div className={'px-5 pt-5'}>
            ...
            <div className='flex items-center gap-4 mb-1'>
              <h1 className='mb-0 text-[28px] leading-[36px] text-[#FFFFFFCC] font-semibold flex items-center gap-1'>
                <span className={'text-[14px] leading-5 text-[#FFFFFFA6]'}>$</span>29,420
              </h1>
            ...
            <p className={'text-[14px] leading-5 font-normal text-[#FFFFFFA6] flex gap-3'}>
          ...
          <div className='flex justify-end px-2 pb-2'>
            <a className={'text-[12px] leading-[18px] text-[#C2D24B]  flex items-center gap-1'}>
              Check Revenue
              <svg
                width='16'
                height='16'
        ...
        >
          <div className={'px-5 pt-5'}>
            ...
            <div className={'text-[12px] leading-5 font-normal text-[#FFFFFFA6] flex gap-9 mb-2'}>
            ...
            <p className={'text-[12px] leading-5 font-normal text-[#FFFFFFA6] flex gap-3 mb-2'}>
              Yesterday
            </p>
            <p className={'text-[12px] leading-5 font-normal text-[#FFFFFFA6] flex gap-3'}>
      ...
      <div>
        ...
        >
          <div className={'col-span-12 md:col-span-7 p-6'}>
            <h3 className={'text-[20px] leading-7 font-semibold mb-5 text-[#FFFFFFCC]'}>Today</h3>
            ...
            <div className={'border-b border-[#2E2F45] py-6'}>
              <div className={'flex items-center justify-between mb-2 '}>
                <div>
                  ...
                  <h1 className={' text-[28px] text-[#FFFFFFCC] leading-[36px] font-semibold '}>
                    9.24k
                  </h1>
                </div>
                <a className={'text-[12px] leading-[18px] text-[#C2D24B]  flex items-center gap-1'}>
        ...
        >
          <div className={'col-span-12 md:col-span-7 p-6'}>
            <h3 className={'text-[20px] leading-7 font-semibold mb-5 text-[#FFFFFFCC]'}>
              Reviews & ratings
            </h3>
            <div className={'flex gap-20'}>
              <div>
                ...
                <div className={`${index === 0 && 'mb-4'}`}>
                  <div className={'flex justify-between mb-[14px]'}>
                    <div className={'flex gap-1 items-start'}>
                      ...
                      />
                      <div>
                        <h4 className={'text-[14px] leading-5 text-[#FFFFFFCC] font-medium'}>
                          Mike Hudson
                        </h4>
                  ...
                  <p className={'text-[12px] leading-[18px] text-[#FFFFFFA6]'}>
                    While the Shahrukh Khan AI chatbot certainly has potential, I feel it's not as
                    engaging as it could be. It might benefit from more interactivity, personalized
                    responses, and a better emulation...
                  </p>
                </div>
              ))}
        ...
        >
          <div className={'col-span-12 md:col-span-6 border-[#2E2F45] md:border-r p-3'}>
            <h4
              className={
            ...
            >
              Countries{' '}
              <span className={'flex items-center gap-2 text-[#C2D24B] font-medium text-[12px]'}>
                Earning & Reports
                <svg
                  width='16'
                  height='16'
