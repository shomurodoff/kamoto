...
const ConversationStyle: React.FC<any> = ({ setOpenEdit }) => {
    ...
    return (
        <div className={"grid grid-cols-12 gap-y-[20px] md:gap-x-[40px]"}>
            ...
            >
                ...
                <InfoCard
                    title={formatMessage({ id: "Understanding Conversation Style of AI Personality" })}
                    desc={formatMessage({
                        id:"In KamotoAI, the \"Conversation Style\" section empowers you to customize the way your virtual AI persona engages in conversations. You can define commonly used fillers, those little linguistic quirks that make your AI personality's interactions more natural and relatable. \n" +
                            "<br/>" +
                            "<br/>" +
                            "Additionally, you have the ability to set standard replies for situations when your AI personality doesn't have a specific answer or when there is a KamotoAI server error. \n" +
                            "<br/>" +
                            "<br/>" +
                            "By shaping the conversation style of your AI persona, you create a unique and engaging experience for users. With KamotoAI, you have the tools to craft AI personalities that strike the perfect balance between authenticity and functionality, fostering meaningful and interactive dialogues." })}
                    slug={"#"}
                />
            </div>
        </div>
