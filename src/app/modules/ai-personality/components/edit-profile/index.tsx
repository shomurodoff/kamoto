      ...
      >
        {map(personalities, (value, index) => (
          ...
          >
            <div
              className={clsx(
                " px-[12px] pt-[20px] pb-[12px] border rounded-md min-h-[100px] max-w-[300px] md:w-auto cursor-pointer",
            ...
            >
              <h4
                className={
                  "text-[#FFFFFF] font-medium text-[13px] leading-[18px] mb-[6px]"
                }
              >
                {get(value, "title")}
              </h4>
              <p
                className={
                  "text-[#FFFFFFA6] font-normal text-[12px] leading-[18px]"
                }
              >
                {get(value, "text")}
              </p>
