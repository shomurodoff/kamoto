        ...
        {(formik) => {
          return (
            <Form className={'col-span-12 md:col-span-7 order-0'}>
              ...
              />
              <label className={'flex text-[13px] leading-5 text-[#FFFFFFA6] mb-1'}>
                Basic Traits Control <ToolTipUI />
              </label>
              <div className={'flex flex-col md:flex-row  gap-y-[24px] md:gap-x-[24px]'}>
                <div className={'p-[20px] pb-[32px] bg-[#171825] rounded md:w-1/2 w-full'}>
                  ...
                  <div className={'py-[20px] border-b  border-[#2E2F45]'}>
                    <Slider startLabel={'Anticipation'} stopLabel={'Surprise'} />
                  </div>
                  <div className={'py-[20px] border-b  border-[#2E2F45]'}>
                    <Slider startLabel={'Anger'} stopLabel={'Fear'} />
                  </div>
