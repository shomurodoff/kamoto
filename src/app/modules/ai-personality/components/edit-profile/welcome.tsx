  ...
  return (
    <div className={"grid grid-cols-12 gap-y-[20px] md:gap-x-[40px]"}>
              ...
              <div className={"bg-[#171825] p-[20px] rounded mt-[20px]"}>
                ...
                <FieldArray
                  ...
                  render={(arrayHelpers) => {
                    return (
                      <>
                        {formik.values.questionTextList.map((_, index) => (
                          <div key={index}>
                            <div
                              className={
      ...
      >
        ...
        <InfoCard
          title={formatMessage({
            id: "Understanding Welcome Presets of AI Personality",
          })}
          desc={formatMessage({
            id:
              'In KamotoAI, the "Welcome Messages & Presets" section allows you to create a captivating and customized first impression for users interacting with your AI personality. You can define a list of default welcome messages that your AI personality will send at the beginning of each chat, setting the tone and establishing a friendly and engaging atmosphere. \n' +
              "<br/>" +
              "<br/>" +
              "Additionally, you have the option to define suggested questions that users can ask, providing them with conversation starters and guiding them towards meaningful interactions. By personalizing the welcome experience, you can make a lasting impact and ensure that users feel welcomed, valued, and excited to engage with your AI personality. ",
          })}
          slug={"#"}
        />
      </div>
