                          ...
                          <div key={index}>
                            ...
                            >
                              <div className={'flex-grow w-full md:w-auto'}>
                                <TextArea
                                  label={formatMessage({id: 'Message' + ' ' + (index + 1)})}
                              ...
                              <div className={'flex justify-end gap-[12px] md:mt-[26px]'}>
                                <button
                                  className={'p-[6px] bg-[#C2D24B1A] rounded-[6px]'}
                                  onClick={() => {
                                    if (!isEqual(index, 0)) arrayHelpers.remove(index)
                                  }}
                                >
                                  <svg
                                    width='24'
                            ...
                            <div className={'flex flex-col md:flex-row  items-start gap-x-[20px]'}>
                              <div className={'flex-grow w-full md:w-auto'}>
                                <TextInput
                                  ...
                                  label={formatMessage({id: 'Question' + ' ' + (index + 1)})}
