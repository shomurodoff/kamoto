    ...
    try {
      if (activityId) {
        ...
        if (success) {
          getActivity();
          toast.success(
            formatMessage({ id: "Acitivity successfully mark as done" })
          );
                ...
                <div className="d-flex align-items-center me-2 position-relative">
                  <img
                    src={
                      mode === "dark"
                        ? toAbsoluteUrl(
                            "/media/icons/investor/ic_dark_call.svg"
                          )
                          ...
                          <div className="card w-200px h-125px shadow rounded kebab-menu-dropdown-container cursor-pointer z-index-1">
                            <div className="border-bottom border-gray-300 border-bottom-2 px-4 py-3 dropdown-items">
                              <button
                                ...
                                disabled={
                                  activity.status === "done" ? true : false
                                }
                              >
                ...
                <div className="d-flex align-items-center me-2 position-relative">
                  <img
                    src={
                      mode === "dark"
                        ? toAbsoluteUrl(
                            "/media/icons/investor/ic_dark_meeting.svg"
                          )
                ...
                <div className="d-flex align-items-center me-2 position-relative">
                  <img
                    src={
                      mode === "dark"
                        ? toAbsoluteUrl(
                            "/media/icons/investor/ic_dark_tasks.svg"
                          )
                ...
                <div className="d-flex align-items-center me-2 position-relative">
                  <img
                    src={
                      mode === "dark"
                        ? toAbsoluteUrl(
                            "/media/icons/investor/ic_dark_mail.svg"
                          )
                ...
                <div className="d-flex align-items-center me-2 position-relative">
                  <img
                    src={
                      mode === "dark"
                        ? toAbsoluteUrl(
                            "/media/icons/investor/ic_dark_notes.svg"
                          )
                ...
                <div className="d-flex align-items-center me-2 position-relative">
                  <img
                    src={
                      mode === "dark"
                        ? toAbsoluteUrl(
                            "/media/icons/investor/ic_dark_documents.svg"
                          )
                        : toAbsoluteUrl(
                            "/media/icons/investor/ic_documents.svg"
                          )
                    }
                    alt="documents icon"
                    className="w-25px h-25px w-md-40px h-md-40px z-index-1"
                      ...
                      <div className="overflow-auto d-flex flex-column gap-2">
                        ...
                        <div className="d-flex flex-wrap pb-5">
                          {activity?.documentImg && (
                            ...
                            >
                              {activity?.documentImg.name.split(".").pop() ===
                              "pdf" ? (
                                <>
                                  <img
                                    alt=""
