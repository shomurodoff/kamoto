...
import {InvestmentConfirmationInitialValues, termSheetStatusValues} from '../core/_constants'
import * as Yup from 'yup'
import {createTransactionApi, getInvestorResponseAPI} from '../core/_requests'
...
export const InvestmentConfirmationModal = ({
  ...
  const intializeInvestmentConfirmationSchema = Yup.object().shape({
    ...
    termSheetStatus: Yup.string().required(formatMessage({id: 'Termsheet Status is required'})),
      ...
      if (roundId && investorId) {
        ...
        if (success && responseData) {
          if (currency) {
            setFormValues({
              ...InvestmentConfirmationInitialValues,
              additionalTermsandCoditions: responseData.additionalTermsandCoditions || '',
                ...
                <Modal.Body>
                  ...
                  <div className='row d-md-flex justify-content-between'>
                    ...
                    <div className='col-md-6'>
                      <SelectInput
                        ...
                        placeholder={formatMessage({id: 'Select Termsheet Status'})}
                        formik={formik}
                        toolTipText={formatMessage({
                  ...
                  <div>
                    <TextArea
                      ...
                      label={formatMessage({id: 'Any Additional Terms & Conditions?'})}
                      toolTipText={formatMessage({
