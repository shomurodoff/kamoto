...
import {
  getAddToCRMData,
  getSingleInvestor,
} from "../../investor-database/core/_requests";
...
export const AddInvestorModal = ({
  ...
  const [dynamicColumnsFromRoundOptions, setDynamicColumnsFromRoundOptions] =
    useState<any>();
                    ...
                    <div>
                      <p className="font-size-16 text-muted mb-5">
                        ...
                        <span className="font-size-16">
                          <Link
                            className="fw-bold"
                            to="/investor-database/create-investor"
                          >
                          ...
                          <div className="highlight-multi-select font-size-12 text-bold mb-6 mt-0 w-md-100 searchable-select">
                            ...
                            <Select
                              ...
                              value={dynamicInvestorsOptions?.find(
                                (option: any) =>
                                  option.value === formik.values["investorId"]
                              )}
                              onChange={(option) =>
                              ...
                              placeholder={formatMessage({
                                id: "Enter Investor or firm Name",
                              })}
