...
export const EditActivityModal = ({
  ...
  const intializeActiveSchema = Yup.object().shape({
    ...
    toTime: Yup.string()
      ...
      .nullable(),
    timeZone: Yup.string().required(formatMessage({id: 'Timezone is required'})),
    guest: Yup.string(),
    activityType: Yup.string().required(formatMessage({id: 'Activity Type is required'})),
  ...
  useEffect(() => {
    if (activityData) {
      setFormValues({
        ...
        documentId: activityData?.documentId ? activityData?.documentId.toString() : '',
      })
  ...
  useEffect(() => {
    if (activityType) {
      if (activityType === 'tasks' || activityType === 'notes' || activityType === 'documents') {
        setHide(true)
      } else {
        setHide(false)
      }
                  ...
                  >
                    <div className='col-12'>
                      <label className='ps-0 font-size-13'>
                        ...
                        <ToolTipUI tooltipText={formatMessage({id: 'Select Meeting time'})} />
                      </label>
                    </div>
                    <div className='col-lg-2 col-md-2 col-xl-2 col-12 height-42px'>
                      ...
                      />
                      <label className='ms-3 fw-semibold'>{formatMessage({id: 'All day'})} </label>
                    </div>
                  ...
                  <div className=' row'>
                    ...
                    >
                      <div className='mx-2 d-flex flex-column'>
                        ...
                        {documentName ? (
                          <p className='mt-2'>{documentName} file uploaded successfully</p>
                        ) : (
                          ''
                        )}
                      </div>
                    </div>
                    <div className={`col-12 col-lg-6 col-xl-6 col-md-6 ${hide ? 'd-none' : ''}`}>
                      <div className='mx-2'>
                        <TextInput
                          fieldType={'text'}
                          label={formatMessage({id: 'Edit Guests'})}
                          fieldName={'guest'}
                          placeholder={formatMessage({id: 'Enter guests email address'})}
                          formik={formik}
                    ...
                    <div className='col-12 col-lg-6 col-xl-6 col-md-6'>
                      <div className='mx-2'>
                        <SelectInput
                          ...
                          placeholder={formatMessage({id: 'Select a Activity Type'})}
                          formik={formik}
                          toolTipText={formatMessage({
