  ...
  return (
    <div>
      ...
      >
        <div
          className={
            "p-[22px] gap-[24px] border-b border-[#2E2F45] flex items-center"
          }
        >
          ...
          <h3
            className={
              "text-[16px] leading-[24px] text-[#FFFFFFCC] font-medium"
            }
          >
            Edit AI Personality
          </h3>
        </div>
        <div className={"max-w-[1240px] mx-auto py-10"}>{children}</div>
      </div>
    </div>
  );
};
